 ...
 * generated in the com.ewell.upload.webservice.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SaveDataResponseReturn_QNAME = new QName("http://webservice.zhending.com", "return");
    private final static QName _DeleteDataJson_QNAME = new QName("http://webservice.zhending.com", "json");
    private final static QName _DeleteDataToken_QNAME = new QName("http://webservice.zhending.com", "token");
    private final static QName _AddCachesKeyChilds_QNAME = new QName("http://webservice.zhending.com", "keyChilds");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ewell.upload.webservice.client
     * 
     */
    ...
    public JAXBElement<String> createSaveDataResponseReturn(String value) {
        return new JAXBElement<String>(_SaveDataResponseReturn_QNAME, String.class, SaveDataResponse.class, value);
    }
    ...
    public JAXBElement<String> createDeleteDataJson(String value) {
        return new JAXBElement<String>(_DeleteDataJson_QNAME, String.class, DeleteData.class, value);
    }
    ...
    public JAXBElement<String> createDeleteDataToken(String value) {
        return new JAXBElement<String>(_DeleteDataToken_QNAME, String.class, DeleteData.class, value);
    }
    ...
    public JAXBElement<String> createGetDataResponseReturn(String value) {
        return new JAXBElement<String>(_SaveDataResponseReturn_QNAME, String.class, GetDataResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zhending.com", name = "keyChilds", scope = AddCaches.class)
    public JAXBElement<String> createAddCachesKeyChilds(String value) {
        return new JAXBElement<String>(_AddCachesKeyChilds_QNAME, String.class, AddCaches.class, value);
    }
    ...
    public JAXBElement<String> createDeleteDataResponseReturn(String value) {
        return new JAXBElement<String>(_SaveDataResponseReturn_QNAME, String.class, DeleteDataResponse.class, value);
    }
    ...
    public JAXBElement<String> createSaveDataJson(String value) {
        return new JAXBElement<String>(_DeleteDataJson_QNAME, String.class, SaveData.class, value);
    }
    ...
    public JAXBElement<String> createSaveDataToken(String value) {
        return new JAXBElement<String>(_DeleteDataToken_QNAME, String.class, SaveData.class, value);
    }
    ...
    public JAXBElement<String> createLoginResponseReturn(String value) {
        return new JAXBElement<String>(_SaveDataResponseReturn_QNAME, String.class, LoginResponse.class, value);
    }
    ...
    public JAXBElement<String> createGetDataJson(String value) {
        return new JAXBElement<String>(_DeleteDataJson_QNAME, String.class, GetData.class, value);
    }
    ...
    public JAXBElement<String> createGetDataToken(String value) {
        return new JAXBElement<String>(_DeleteDataToken_QNAME, String.class, GetData.class, value);
    }
