...
public class ObjectFactory {
    ...
    private final static QName _AddCachesKeys_QNAME = new QName("http://webservice.zhending.com", "keys");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zhending.com", name = "keys", scope = AddCaches.class)
    public JAXBElement<String> createAddCachesKeys(String value) {
        return new JAXBElement<String>(_AddCachesKeys_QNAME, String.class, AddCaches.class, value);
    }
